...
<html>
  ...
  <body>
  <c:forEach var="info" items="${requestScope.infoFindByType }">
  		<div class="news-list-item clearfix">
            <div class="col-xs-8">
              <a href="UserInfoServlet?username=${info[8] }" target="_blank" style="color: black;font-size: 30px">${info[8] }:</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a style="color: red;font-size: 20px">${info[1] }</a>&nbsp;&nbsp;
              <a style="color: red;font-size: 20px">${info[2] }</a>&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a style="color: black;font-size: 20px">${info[3] }</a>
              <div class="info" align="right" style="width: 701px; ">
                <span style="color: red">999</span>评论 ⋅
                <span style="color: black">${info[6] }</span>
              </div>
            </div>
            <%

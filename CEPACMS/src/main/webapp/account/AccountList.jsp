...
<div class="panel admin-panel">
  <form id="form1" role="form" name="form" action="/CEPACMS/Account/queryKeyWords.do" method="post">
  ...
  <table class="table table-hover text-center">
   ...
   <c:forEach items="${aList}" var="acc">
    <tr>
      ...
      <td><c:if test="${acc.accountStatus==1}">停用</c:if>
          <c:if test="${acc.accountStatus==0}">启用</c:if></td>
      <td>
      ...
      <c:if test="${role==1 }">
      <a class="button border-main" href="/CEPACMS/Account/edit.do?accountID=${acc.accountID}"><span class="icon-edit"></span> 修改</a>
      <a onclick="return delete_onclick()" class="button border-red" href="/CEPACMS/Account/delete.do?accountID=${acc.accountID}"><span class="icon-trash-o"></span> 删除</a>
      </c:if>
      </div></td>
      </c:if>
    </tr>
    ...
    <tr>
      <td colspan="7">
        <div class="pagelist"> <a href="/CEPACMS/Account/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex-1}" id="pPage">上一页</a>
          ...
          <a href="/CEPACMS/Account/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex+1}" id="nPage">下一页</a>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/CEPACMS/Account/add.do">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="radio" class="cls_rad" name="accountStatus" value="0" checked="checked"/>启用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" class="cls_rad" name="accountStatus" value="1"  />停用
          <div class="tips">
          </div>
        </div>
      </div>

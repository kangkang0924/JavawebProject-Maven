...
<div class="panel admin-panel margin-top" id="add">
  <div class="body-content">
    <form method="post" class="form-x" action="/CEPACMS/Record/update.do">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <c:choose>
            <c:when test="${record.rIsNucleicAcidTest==1}">
              <input type="radio" name="rIsNucleicAcidTest" value="1" checked="checked"/>&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="rIsNucleicAcidTest" value="0" />&nbsp;否
            </c:when>
            <c:when test="${record.rIsNucleicAcidTest==0}">
              <input type="radio" name="rIsNucleicAcidTest" value="1" />&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="rIsNucleicAcidTest" value="0" checked="checked"/>&nbsp;否
            </c:when>
            <c:otherwise>
              <input type="radio" name="rIsNucleicAcidTest" value="1" />&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="rIsNucleicAcidTest" value="0" />&nbsp;否

...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1>
    <img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />社区疫情防控信息管理中心</h1>
    <br>
  </div>
  
  <div class="head-l" style="padding-right: 350px;text-align: center;margin-top: 15px">
      
      <h5 style="text-align: center;color:#ff6600">欢迎&nbsp;&nbsp;${username}&nbsp;&nbsp;来到社区疫情防控信息管理系统</h5>
  </div>
...
<div class="leftnav">
  ...
  <ul>
    <li><a href="upload/UploadList.jsp" target="right"><span class="icon-caret-right"></span>文件上传</a></li>
    <%-- <c:if test="${role==1 }"> --%>
    <li><a href="download/DownloadList.jsp" target="right"><span class="icon-caret-right"></span>文件下载</a></li>
    <%-- </c:if> --%>
  </ul>

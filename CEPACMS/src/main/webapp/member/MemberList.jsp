...
<script src="<%=basePath%>js/pintuer.js"></script>
  <script type="application/javascript">
    ...
    function del(){
      ...
      form1.action = "/CEPACMS/Member/deletes.do";
      form1.submit();
    }
  </script>
</head>
...
<div class="panel admin-panel">
  <form id="form1" role="form" name="form" action="/CEPACMS/Member/queryByKeyWords.do" method="post">
  ...
  <table class="table table-hover text-center">
   ...
   <c:forEach items="${mList}" var="mem">
    <tr>
      ...
      <c:if test="${role==1 }">
      <a class="button border-main" href="/CEPACMS/Member/edit.do?mId=${mem.mId}"><span class="icon-edit"></span> 修改</a>      
            <a onclick="return delete_onclick()" class="button border-red" href="/CEPACMS/Member/delete.do?mId=${mem.mId}"><span class="icon-trash-o"></span> 删除</a>
      </c:if>
      </div></td>
    </tr>
   </c:forEach>
    <tr>
      <td colspan="7">
        <div class="pagelist"> <a href="/CEPACMS/Member/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex-1}" id="pPage">上一页</a>
          ...
          <a href="/CEPACMS/Member/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex+1}" id="nPage">下一页</a>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/CEPACMS/Member/add.do">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mVaccine" value=""  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">

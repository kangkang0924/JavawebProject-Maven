...
<div class="panel admin-panel">
  <form id="form1" role="form" name="form" action="/CEPACMS/Community/queryByKeyWords.do" method="post">
  ...
  <table class="table table-hover text-center">
   ...
   <c:forEach items="${list}" var="com">
    <tr>
      ...
      <c:if test="${role==1 }">
      <a class="button border-main" href="/CEPACMS/Community/edit.do?cId=${com.cId}"><span class="icon-edit"></span> 修改</a>
      <a onclick="return delete_onclick()" class="button border-red" href="/CEPACMS/Community/delete.do?cId=${com.cId}"><span class="icon-trash-o"></span> 删除</a>
      </c:if>
      </div></td>
    </tr>
   </c:forEach>
    ...
    <tr>
      <td colspan="7">
        <div class="pagelist"> <a href="/CEPACMS/Community/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex-1}" id="pPage">上一页</a>
          ...
          <a href="/CEPACMS/Community/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex+1}" id="nPage">下一页</a>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/CEPACMS/Community/add.do">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="cProvince" value=""  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="cCity" value=""  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="cStreet" value=""  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">

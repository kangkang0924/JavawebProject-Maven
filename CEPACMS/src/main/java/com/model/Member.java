...
public class Member {
    ...
    public Member(int mId, String mName, String mVaccine, String mTel, String mSex, int mAge, String mHouseNum, String mWorkUnit, String mCarNum, String mIsHousehold, int mcId) {
        this.mId = mId;
        this.mName = mName;
        this.mVaccine = mVaccine;
        this.mTel = mTel;
    ...
    public Member(int mId, String mName, String mVaccine, String mTel, String mSex, int mAge, String mHouseNum, String mWorkUnit, String mCarNum, String mIsHousehold, int mcId, String cName) {
        this.mId = mId;
        this.mName = mName;
        this.mVaccine = mVaccine;
        this.mTel = mTel;
